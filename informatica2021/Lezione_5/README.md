...
1. Scaricare il file con dati copiando e incollando il commando seguente su terminale:
    ```bash
    wget https://raw.githubusercontent.com/scarrazza/informatica2021/master/Lezione_5/data.dat
    # oppure se siete su macOS
    curl https://raw.githubusercontent.com/scarrazza/informatica2021/master/Lezione_5/data.dat -o data.dat
    ```
