...
Il tema d'esame e rispettivi dati sono disponibili sul server `tolab.fisica.unimi.it` nella cartella `/home/comune/20220114_SC`. In particolare, il testo del tema d'esame è contenuto nel file `esame.pdf`.
